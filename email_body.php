...
function getEmailBody ()
{
    return
        ...
        . '<p>The programme is scheduled to start from 6.00pm followed by dinner. </p> </br></br>'
        . '<p>We look forward to seeing you on the day and hearing more about your business from you. </p> </br></br>'
