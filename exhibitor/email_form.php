...
function sendMail ()
{
    ...
    $sendMailSubject = 'Showcase your business On UKBCCI Trade Show and Business Networking Event';
    ...
    $mail->setFrom($mail_username, 'UKBCCI Product Showcase');
    ...
    if($mail->addReplyTo($_POST['email'], $_POST['name'])) {
        ...
        // $mail->addAddress('samira.giantssoft@gmail.com', 'Imam Uddin Ahmad');
        // $mail->addCC('samirashammi21@gmail.com', 'ShabUddin');

        $mail->addAddress('i.ahmad@ukbccimidlands.org', 'Imam Uddin Ahmad');
        $mail->addCC('shab@elipos.co.uk', 'ShabUddin');
        $mail->Subject = 'Showcase your business On UKBCCI Trade Show and Business Networking Event';
